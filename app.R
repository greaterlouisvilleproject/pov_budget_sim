   ...
   sidebarLayout(
      mainPanel(
         ...
         radioButtons("housing",
                     ...
                     choices = list("Studio Apartment" = 551, 
                                    "2 Bedroom Apartment" = 793, 
                                    "3 Bedroom Apartment" = 1085)),
         radioButtons("food",
                      "Monthly Food Costs: ",
         ...
         radioButtons("transit",
                      ...
                      choices = list("2 TARC Bus Passes" = 100, 
                                     "1 used car ($309)" = 309, 
                                     "2 used cars ($618)" = 618)),
         radioButtons("tech and entertainment",
                      "Monthly Technology Costs: ",
                      choices = list("Landline or prepaid phone, over the air TV" = 15, 
                                     "Landline, Internet, Cable TV" = 90, 
                                     "Cell Phones, Internet, Cable TV" = 210)),
         radioButtons("other",
                      "Monthly Other Costs: ",
